...
export const UI = {
  GRID: GRID_RECT(0, 0, 19, 12),
  LEFT_PANEL: GRID_RECT(1, 1, 4, 9),
  CENTER_PANEL: GRID_RECT(5, 1, 9, 10),
  RIGHT_PANEL: GRID_RECT(14, 1, 4, 10),
  LEFT_TRAY: GRID_RECT(1, 10, 4, 1),
  RIGHT_TRAY: GRID_RECT(14, 10, 4, 1),
  BOARD: GRID_RECT(6, 2, 7, 7),
  HAND: GRID_RECT(7, 10, 5, 1),
  TABLE: GRID_RECT(5, 10, 9, 1),
  MORALE: GRID_RECT(5, 10, 1, 1),
  DRAW_PILE: GRID_RECT(6, 10, 1, 1),
  DISCARD_PILE: GRID_RECT(12, 10, 1, 1),
  GRAVE_PILE: GRID_RECT(13, 10, 1, 1),
  END_TURN_BUTTON: GRID_RECT(9, 11, 2, 1),
  BACK_BUTTON: GRID_RECT(9, 11, 2, 1),
...
export class GameInfo {
  ...
  render(bounds) {
    ...
    y += writeText(this.description, bounds.center.x + 1, y, bounds.w - 2);
